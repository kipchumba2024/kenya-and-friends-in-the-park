...
export function TravelPage() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-red-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 py-12 px-4">
      <div className="container mx-auto max-w-7xl">
        ...
        <header className="text-center mb-14">
          <div className="inline-flex items-center gap-2 bg-red-100 dark:bg-red-900/40 text-red-600 dark:text-red-400 px-4 py-1 rounded-full text-sm font-semibold">
            <FaPlane /> Visitor Guide 2024
          </div>

          <h1 className="mt-4 text-4xl md:text-5xl font-extrabold bg-gradient-to-r from-red-600 to-orange-500 bg-clip-text text-transparent">
          ...
          <section className="space-y-12">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-3xl p-8 shadow-md border border-slate-200 dark:border-slate-800">
              ...
              <img
                ...
                alt="Travel guidance"
                className="mt-6 rounded-2xl shadow-lg max-w-md"
              />

              <div className="mt-6 space-y-3 text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
                <p><strong>Ealing Common</strong> – Tube station (London)</p>
                <p className="flex items-center gap-2">
                  <FaBus className="text-red-500" />
                  Bus 207 (Stop EK) → Stop GN (Brentside High School), ~2 mins
                </p>
                <p className="flex items-center gap-2">
                  <FaWalking className="text-red-500" />
                  4 min walk (0.2 mile) via Uxbridge Rd/A4020
                </p>
              </div>
            </div>
